...
local redzlib = {
	Themes = {
		...
		Orange = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(40, 25, 10)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(60, 30, 10)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(40, 25, 10))
			}),
			["Color Hub 2"] = Color3.fromRGB(50, 30, 15),
			["Color Stroke"] = Color3.fromRGB(80, 40, 20),
			["Color Theme"] = Color3.fromRGB(255, 123, 50),
			["Color Text"] = Color3.fromRGB(255, 255, 240),
			["Color Dark Text"] = Color3.fromRGB(200, 180, 160)
		},
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
...
function redzlib:MakeWindow(Configs)
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "بروح امك لاتغلق السكربت",
			Text = "صدگ تريد تغلق السكربت؟ ",
			Options = {
				{"اغلاق", function()
					ScreenGui:Destroy()
				end},
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			MinimizeButton.Image = "rbxassetid://13915713218"
			CreateTween({MainFrame, "Size", SaveSize, 0.25, true})
			ControlSize1.Visible = true
			ControlSize2.Visible = true
			Minimized = false
		else
			MinimizeButton.Image = "rbxassetid://14597261191"
...
Callback)
	...
	function Window:MakeTab(paste, Configs)
		...
		TabSelect.Activated:Connect(function(...)
    playClickSound()
Tabs)
...
-- تأكيد تشغيل الواجهة
print("✅ Redz Library V5 Loaded Successfully!")

-- إذا كان الملف عبارة عن مكتبة GUI فقط، نضيف مثال بسيط لإنشاء نافذة
if typeof(redzlib) == "table" and redzlib.Info and redzlib.Info.Version then
    print("📦 Library Version:", redzlib.Info.Version)
end
